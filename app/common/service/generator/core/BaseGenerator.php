...
abstract class BaseGenerator
{
     ...
     * @return mixed|string
     * @author 张晓科
     * @date 2023/6/24 10:18
     */
    public function getAuthorContent()
    {
        return empty($this->tableData['author']) ? 'ideaadmin' : $this->tableData['author'];
    }
