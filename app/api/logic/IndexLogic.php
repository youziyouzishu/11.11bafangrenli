...
class IndexLogic extends BaseLogic
{
     ...
     */
    public static function getDecorate($id, $role = 2)
    {
     ...
     */
    public static function getConfigData($role = 2)
    {
        // 底部导航
        $tabbar = DecorateTabbar::getTabbarLists($role);
        // 导航颜色
        ...
        $loginConfig = [
            ...
            // 注册强制绑定手机
            'coerce_role' => ConfigService::get('login', 'coerce_mobile', config('project.login.coerce_mobile')),
        ];
        // 网址信息
        $website = [
