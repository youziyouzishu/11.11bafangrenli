        ...
        <ul class="list">
          <li class="line">
            ...
            <a class="link" @click="toggleDisclaimer">
              ...
              <div v-if="isDisclaimerBoxShow" :class="['disclaimer-container', 'container', isH5 && 'container-h5']"
      ...
      `Home.IM（“本产品”）是由腾讯云提供的一款测试产品，腾讯云享有本产品的著作权和所有权。本产品仅用于功能体验，不得用于任何商业用途。依据相关部门监管要求，严禁在使用中有任何色情、辱骂、暴恐、涉政等违法内容传播。`
          ...
          <li class="line">
            ...
            <a class="link" @click="toggleCancellation">
              ...
              <div v-if="isCancellationBoxShow" :class="['cancellation-container', 'container', isH5 && 'container-h5']"
