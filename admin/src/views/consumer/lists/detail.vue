        ...
        <el-card class="mt-4 !border-none" header="基本资料" shadow="never">
            <el-form ref="formRef" class="ls-form" :model="formData" label-width="120px">
                ...
                <el-form-item label="个人简介：">
                    {{ formData.profile || '-' }}
                    <popover-input class="ml-[10px]" @confirm="handleEdit($event, 'profile')" :limit="32"
                        v-perms="['user.user/edit']">
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                        </el-button>
                ...
                <el-form-item label="身份证号：">
                    {{ formData.id_card || '-' }}
                    <popover-input class="ml-[10px]" @confirm="handleEdit($event, 'id_card')" :limit="32"
                        v-perms="['user.user/edit']">
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                        </el-button>
                ...
                <el-form-item label="银行名称：">
                    {{ formData.bank_name || '-' }}
                    <popover-input class="ml-[10px]" @confirm="handleEdit($event, 'bank_name')" :limit="32"
                        v-perms="['user.user/edit']">
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                        </el-button>
                ...
                <el-form-item label="银行账号：">
                    ...
                    <popover-input class="ml-[10px]" @confirm="handleEdit($event, 'bank_account')" :limit="32"
                        v-perms="['user.user/edit']">
                        <el-button type="primary" link>
                            <icon name="el-icon-EditPen" />
                        </el-button>
