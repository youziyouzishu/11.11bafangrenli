    ...
    <div class="login-register">
        <el-form ref="formRef" :rules="rules" :model="formData" label-width="120px">
            <el-card shadow="never" class="!border-none">
                ...
                <el-form-item label="强制绑定角色" prop="coerce_role">
                    <div>
                        <el-switch v-model="formData.coerce_role" :disabled="true" :active-value="1"
                            :inactive-value="0" />
                        <span class="mt-1 ml-2">{{
            formData.coerce_role ? '开启' : '关闭'
        }}</span>
...
const rules = reactive<FormRules>({
    ...
    coerce_role: [{ required: true, trigger: 'blur' }]
})
