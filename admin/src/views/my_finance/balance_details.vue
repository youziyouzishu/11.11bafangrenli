    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <el-table size="large" v-loading="pager.loading" :data="pager.lists">
                <!-- <el-table-column label="编号" prop="sn" min-width="150" /> -->
                <el-table-column label="公司" prop="nickname" min-width="200" show-overflow-tooltip>
                ...
                <el-table-column label="类型" prop="change_type_desc" min-width="90" />
