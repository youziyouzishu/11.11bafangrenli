<template>
    <div class="dialog">
        ...
        <el-drawer v-model="visible" :show-close="true" :custom-class="customClass" :title="title"
            :visible.sync="drawer" @closed="close" :size="width" :wrapperClosable="false" :modal="false">
...
.customClass .el-drawer__header .el-drawer__close {
